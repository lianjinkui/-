    ...
    <div id="app">
        ...
        <div class="classify">
            ...
            适合无编程基础但想学H5前端开发的同学入门学习，也适合UI、Java、PHP等其他学科学员预习或练习。本课程通过新闻页面、个人主页、个人简历、场景秀等多个项目案例由浅入深以项目实战的方式让同学们体验到前端开发乐趣。本课程突出实战，如果希望深入学习课程中涉及到的知识可报名学习智游前端开发课程。
             		...
             		<p>前端开发环境搭建</p>
             		<div class="classify-v-info"><span class="count" title="观看次数"><img src="z/count.png" alt="">433</span>
             		<span class="duration" title="视频时长"><img src=z/player.png" alt="">562</span></div>
             		</li>            	
        ...
        <div class="classify">
            ...
            适合有一定HTML+JS基础、想学习React的同学。本课程循序渐进、浅显易懂，非常适合React入门学习。想进一步学习和使用React进行开发的同学可以报名智游前端开发课程。
             		...
             		<div class="thum" style="background-image: url(src/main/webapp/z/html5.jpg)"></div>
             		<p>React快速体验-组件</p>
